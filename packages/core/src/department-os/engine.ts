...
export const DEFAULT_DEPARTMENTS: readonly DepartmentSeedSpec[] = [
  ...
  {
    key: "creative_production",
    name: "Creative Production",
    mission:
      "Create, manage, and improve visual, video, deck, PDF, and social assets for every business — on-brand, audience-aware, and conversion-focused.",
    operating_loop: [
      "receive creative objective",
      "load business brand profile + campaign context",
      "identify audience + channel + format",
      "generate concept + copy/visual brief",
      "produce/prepare asset through the available tool",
      "QA for brand, clarity, claims, conversion",
      "request approval",
      "export/schedule/send if allowed",
      "track performance + save winning templates",
    ],
    ai_employees: [
      "Creative Director",
      "Visual Brand Agent",
    ...
    kpis: [
      ...
      "on-brand pass rate",
      "approval rate",
      "creative conversion lift",
      "winning templates saved",
      "claims flagged before publish",
    ],
    review_cadence: "weekly",
  },
  {
    key: "organizational_development",
    name: "Organizational Development (CODO)",
    mission:
      "Continuously improve the health, performance, communication, efficiency, learning, and collaboration of the AI organization — high-performing organizations are designed, not accidental.",
    operating_loop: [
      "monitor communication / delegation / context / handoff quality",
      "track employee + department workload and bottlenecks",
      "run the weekly organization review",
      "diagnose repeated mistakes + knowledge/training gaps",
      "improve instructions / SOPs / templates / routing (train, don't replace)",
      "produce the monthly CEO coaching report",
      "measure org-health score + leverage",
    ],
    ai_employees: [
      "Chief Organizational Development Officer",
      "Communication Auditor",
      "Training Agent",
      "Workload/Wellness Monitor",
      "Process Auditor",
      "Org Intelligence Analyst",
    ],
    kpis: [
      "org health score",
      "delegation quality score",
      "bottlenecks resolved",
      "approval delay reduced",
